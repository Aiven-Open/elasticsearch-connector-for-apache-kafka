...
public class ElasticsearchWriterTest extends ElasticsearchSinkTestBase {
  ...
  public void testIgnoreNullValue() throws Exception {
    ...
    ElasticsearchWriter writer = initWriter(client, DataConverter.BehaviorOnNullValues.IGNORE);
    writeDataAndRefresh(writer, records);
  ...
  public void testDeleteOnNullValue() throws Exception {
    ...
    ElasticsearchWriter writer = initWriter(client, DataConverter.BehaviorOnNullValues.DELETE);
  ...
  public void testFailOnNullValue() throws Exception {
    ...
    ElasticsearchWriter writer = initWriter(client, DataConverter.BehaviorOnNullValues.FAIL);
    try {
      writeDataAndRefresh(writer, records);
  ...
  private ElasticsearchWriter initWriter(ElasticsearchClient client, DataConverter.BehaviorOnNullValues behavior) {
